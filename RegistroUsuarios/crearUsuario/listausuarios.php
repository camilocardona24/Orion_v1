...
$result = Conexion::consulta("select cedula,nombre_completo,nombre_usuario,perfil,'<a href=http://192.168.50.187/spsa/RegistroUsuarios/editarUsuario?cedula=' || cedula || '>Editar&nbsp;&nbsp;&nbsp;</a><a href=http://192.168.50.187/spsa/RegistroUsuarios/crearUsuario/eliminarUsuario.php?cedula=' || cedula || '>Eliminar</a>' from usuarios_sps;");
